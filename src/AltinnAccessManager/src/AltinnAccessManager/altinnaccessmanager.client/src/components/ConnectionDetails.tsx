...
import { Card, Heading, Paragraph, Button, Alert, Spinner, Tag, Modal } from '@digdir/designsystemet-react';
import type { ConnectionDto, PackagePermissionDto, RolePermissionDto, ResourcePermissionDto, PersonInput } from '../types/connections';
